...
#Agent-based model tih analysis of extinction.
    ...
    for j in range (1,len(tiempo)):
        ...
        if (n_A+n_B)>100000000: #Upper bound.
            ...
            for i in range(j, len(tiempo)):
                n_total[i]=(n_A+n_B)
            break
    return n_A, n_B,n_total,tiempo, extincion, tiempo_extincion, tiempo_cota_superior #El insert simplemente es para añadir el origen de tiempos.
...
def prob_extincion(numero_simulaciones,entornos,n_A,n_B,kappa_0_to_1,kappa_1_to_0,k_A,k_B,pi_A_to_B,pi_B_to_A):
    ...
    #Aux vari to calculate the mean of the active populations.
    n_A_media=0
    n_B_media=0
    n_plot=[]
...
'''
pi_A_to_B=0.269; pi_B_to_A=0.243
numero_extincion=prob_extincion_simple(1000, entornos, n_A, n_B, kappa_0_to_1, kappa_1_to_0, k_A, k_B, pi_A_to_B, pi_B_to_A)
